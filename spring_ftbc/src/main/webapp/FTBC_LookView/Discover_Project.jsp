...
<link rel="stylesheet" type="text/css" href="Discover_Project.css?Lu33dga">
</head>
<body>
	<script type="text/javascript">
		...
		$(window).scroll(function(){   //스크롤이 최하단 으로 내려가면 리스트를 조회하고 page를 증가시킨다.
		     if($(window).scrollTop() == $(document).height() - $(window).height()){
		           s = s+8;
		           e = e+8;
		           kindProject('<%=kind%>',s,e);
		     } 
		});
		function kindProject(sort,s,e){
			$.ajax({
				method:'get',
				url:'/Project/getDiscoverProjects?sort='+sort+'&s='+s+'&e='+e,
