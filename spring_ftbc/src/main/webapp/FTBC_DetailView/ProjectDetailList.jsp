...
<%
	...
	/////////////////////10-24
	String pjo_code=pVO.getProject_code();
	...
	float value = (float) ((Double.valueOf(pVO.getFundedMoney()) / Double.valueOf(pVO.getFd_targetMoney())) * 100);
%>
<!-- 서브 카테고리 -->
<div class="row">
				...
				if(pVO.getOutLine()<0){
					...
					<div id="bottom_rewardCards_rewardHeader">
						<table style="width: 100%">
                           ...
                           <%=(Integer.parseInt(gVO.GIFT_LIMITED.toString())) - gVO.getSupport_num()%>개 남음</span> <%
                                 }else{ %>
					...
					<div class="Divider"></div>
                           ...
                           %>
                            ...
                            <%
                                	...
                                	%>
                                	<input class="magam_bottom_btn" type="button" value="선물 선택하고 밀어주기">
                                	<% 
									}
								}else{%>
									<input class="bottom_btn" type="button" value="선물 선택하고 밀어주기">
