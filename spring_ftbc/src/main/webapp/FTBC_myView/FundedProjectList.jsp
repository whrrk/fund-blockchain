...
%>
					<div class="card col-xs-3" onclick="projectDetail('<%=pVO.getProject_code()%>')">
						...
						<div class="card-body">
							...
							<hr width=<%=(float)((Double.valueOf(pVO.getFundedMoney())/Double.valueOf(pVO.getFd_targetMoney()))*100)%>% align="left" class="card_hr">
...
%>
					<div class="card col-xs-3" onclick="projectDetail('<%=pVO.getProject_code()%>')">
						...
						<div class="card-body">
							...
							<span class="card-text project_cost col-xs-7"><%=pVO.getFundedMoney()%>원&nbsp;&nbsp;&nbsp;<%=(long)((Double.valueOf(pVO.getFundedMoney())/Double.valueOf(pVO.getFd_targetMoney()))*100)%>%</span>
						</div>
					</div>
<%
					}
