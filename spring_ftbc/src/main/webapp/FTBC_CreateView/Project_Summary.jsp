...
<!--=============================================================================================
	...
	날짜:2019-09-12
================================================================================================  -->
<link rel="stylesheet" type="text/css" href="Project_Summary.css?0">
</head>
<body>	
<!--=============================================================================================
	프로젝트 올리기 - 프로젝트 개요 탭
...
<!-- <div id="pjo_creator"> -->
	...
	<!-- ================================= 창작자 이름 입력창 =========================================== -->
		<div id="pjo_name_edit">
			...
			<div class="row">
				<div class="col-sm-6">
				    <input type="text" id="pjo_name_text" name="pjo_name_text" placeholder="이름을 입력해 주세요" value="<%=session.getAttribute("mem_name")%>">
