...
<link rel="stylesheet" type="text/css" href="../FTBC_CreateView/Project_Composition.css?2">
<script>
...
/* 	window.onload = function() {
	...
	function goalMoneyRegistration() {
		...
		$("#goalMoneyOutput").val($("#goalMoneyInput").val());
	...
	function projectEndDateOutputShow() {
		if($("#datepicker").val()!=""){
		$("#projectEndDateOutput").val($("#datepicker").val());
		paymentEndDate();
	...
	function giftAdd() {
		...
		for (var i = 0; i < 100; i++) {// 선물의 개수
			for (var j = 0; j < 5; j++) {// 옵션의 개수
				var tempi = String(i);
				var tempj = String(j);
				console.log($("#GiftUlListName"+tempj+tempi).val());
				console.log($("#GiftUlListOption"+tempj+tempi).val());
				console.log($("#GiftUlListQuantity"+tempj+tempi).val());
			}
		}
	}
	/////////////////////////선물 추가 끝/////////////////////////////////
					...
					<div class="row">
						<div class="col-xs-2">
							<input type="text" class="ilbanText" id="GiftUlListName"
								name="GiftUlListName" readOnly style="text-align:center;width:auto; margin-top:-5px;">
						</div>
						<div class="col-xs-1">
							x <input type="text" class="ilbanText" id="GiftUlListQuantity"
								name="GiftUlListQuantity" readOnly style="text-align:center;width:50px;margin-top:-5px;">
...
예시) 사이즈, 메시지 순으로 작성해 주세요."
		...
		<table id="defaultHideListTable">
			<tbody id="defaultHideList">
				<tr>
					<td><input type="text" class="ilbanText" id="itemListNameInput" name="itemListNameInput" readOnly></td>
					<td><input type="text" class="ilbanText" id="itemListOptionInput" name="itemListOptionInput" readOnly></td>
