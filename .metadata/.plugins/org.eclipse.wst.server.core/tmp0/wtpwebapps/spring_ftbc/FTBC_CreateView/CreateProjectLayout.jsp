				...
				<div class="row" id="content">
					<div class="col-lg-8 ">
						<ul class="nav nav-tabs">
							<li class="active" id="tab1"><a class="tab_menu"
								data-toggle="tab" href="#menu1"> <span id="check_tab1"><img
										src="../FTBC_Images/check1.png"></span>&nbsp;프로젝트 개요
							</a></li>
							<li id="tab2"><a class="tab_menu" data-toggle="tab"
								href="#menu2"> <span id="check_tab2"><img
						...
						<div class="btns">
							...
							<div id="d_request">
								<a href="#" id="btn_request" data-toggle="modal"
									data-target="#myModal" onClick="check_modal()">검토 요청하기</a>
							</div>
						</div>
					</div>
				</div>
			...
			<script type="text/javascript">
				function check_modal() {
					...
					if (count.length > 1) {
						...
						$("#modal_img").html(
								'<img src="../FTBC_Images/check3.png" />');
						$("#modal-footer")
								.html(
